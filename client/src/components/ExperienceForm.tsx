...
export default function ExperienceForm({ 
  ...
  const removeHighlight = (index: number) => {
    setExperience((prev) => {
      ...
      return { ...prev, highlights: updatedHighlights.length ? updatedHighlights : [""] };
    });
  };
  ...
  const handleSubmit = () => {
    ...
    const filteredHighlights = experience.highlights.filter(h => h.trim() !== "");
  ...
  return (
    <motion.div 
      ...
      className="bg-gray-800/20 border border-gray-700 rounded-lg p-4 md:p-6 mb-6"
    >
